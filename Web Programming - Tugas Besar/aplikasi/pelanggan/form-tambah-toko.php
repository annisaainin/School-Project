      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li><a href="data-toko.php"><b>Toko Saya</b></a> / Tambah Toko</li>
          </ol>
          <!-- Page Heading -->
          <!-- DataTales Example -->
                ...
                <form action="pro-tambah-toko.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan No. Telepon Toko" name="telp_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">No. Whatsapp</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan No. Whatsapp Toko" name="wa_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">RT</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan No. RT" type="text" name="rt_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">RW</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan No. RW" type="text" name="rw_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">Alamat</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Alamat" type="text" name="jalan_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">Desa</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Desa" type="text" name="desa_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">Kecamatan</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Kecamatan" type="text" name="kec_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">Kota</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Kota" type="text" name="wil_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-9">Provinsi</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Provinsi" type="text" name="prov_toko" required="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Deskripsi" type="text" name="des_toko" required="">
                      </div>
                    </div>
                    <!-- <div class="form-group">
                      <label class="col-lg-9">Jarak</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" readonly value="-" type="text" name="jarak_toko" required="">
                      </div>
                    </div> -->
                    <div class="form-group">
                      <label class="col-lg-9">Link Google Maps</label>
                      <div class="col-lg-12">
                        <input class="form-control form-control-user" placeholder="Masukkan Link" type="text" name="gmaps" required="">
                      </div>
                    </div>
