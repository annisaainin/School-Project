...
if($qry==true){
    ...
    if($stastok=="ada"){
             ...
             $query = mysqli_query($koneksi,"INSERT INTO tb_pesanan(id_pesanan,tgl_pesanan,total_kuantitas,total_berat,harga_kg,harga_km,total_cashback,total_keseluruhan,des_pesanan,id_user,id_toko,id_metode,status_bayar)VALUES('$id_pesanan','$tgl_pesanan','$total_kuantitas','$total_berat','$harga_kg','$harga_km','$total_cashback','$total_keseluruhan','$des_pesanan','$id_user','$id_toko','$id_metode','$status_bayar')")or die(mysqli_error($koneksi));
