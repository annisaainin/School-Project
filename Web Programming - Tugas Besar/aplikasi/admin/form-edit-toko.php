        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
              <div class="card-body">
                <?php 
                  $data=mysqli_query($koneksi,"SELECT * from tb_toko t inner join tb_user u on t.id_user=u.id_user WHERE t.id_toko='$id_toko' group by t.id_toko");
                      ...
                      <div class="col-lg-6">
                        <select class="form-control" name="nama_pemilik"  required>
                          <option value="<?php echo $r['id_user']; ?>"><?php echo $r['nama_user']; ?></option>
                              <?php
                                include "../../koneksi/koneksi.php";
                                $query3 = mysqli_query($koneksi,"SELECT * FROM tb_user where id_hak_akses='HK00002'");
                                  while ($data3=mysqli_fetch_array($query3)){
                                  ?>
                                  <option value="<?php echo $data3['id_user']; ?>"><?php echo $data3['nama_user']; ?></option>
                                  <?php
                                  }
                                ?>
                            </select>
