...
$query = mysqli_query($koneksi,"UPDATE tb_toko SET nama_toko='$nama_toko',telp_toko='$telp_toko',wa_toko='$wa_toko',rt_toko='$rt_toko',rw_toko='$rw_toko',jalan_toko='$jalan_toko',desa_toko='$desa_toko',kec_toko='$kec_toko',wil_toko='$wil_toko',prov_toko='$prov_toko',kode_pos='$kode_pos',des_toko='$des_toko',jarak_toko='$jarak_toko',gmaps='$gmaps',id_user='$nama_pemilik' where id_toko='$id_toko'");
