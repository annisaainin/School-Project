                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                      <div class="form-group">
                                        <label class="col-lg-9">Tanggal Awal</label>
                                        <div class="col-lg-12">
                                          <input class="form-control form-control-user" placeholder="Masukkan Nama Penjadwalan" type="date" name="tgl_pengiriman" required="">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="col-lg-9">Tanggal Sampai</label>
                                        <div class="col-lg-12">
                                          <input class="form-control form-control-user" placeholder="Masukkan Nama Penjadwalan" type="date" name="tgl_pengiriman" required="">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="col-lg-9">Jenis Laporan</label>
                                          <div class="col-lg-12">
                                            <select class="form-control" name="jenis_barang"  required>
                                              <option value=""> --- Pilih Jenis Laporan --- </option>
                                                  <option value="1"> Laporan Barang </option>
                                                  <option value="2"> Laporan Pesanan </option>
                                                  <option value="1"> Laporan Pengiriman </option>
                                                  <option value="1"> Laporan Pelanggan </option>
                                                </select>
                                          </div>
                                      </div> 
                                 <div class="form-group">   
