...
$query = mysqli_query($koneksi,"INSERT INTO tb_user(id_user,nip_user,nama_user,alamat_user,email_user,telp_user,ttl_user,username_user,password_user,jenis_kelamin,id_hak_akses) VALUES('$id_user','$nip_user','$nama_user','$alamat_user','$email_user','$telp_user','$ttl_user','$username_user','$password_user','$jenis_kelamin','HK00001')")or die(mysqli_error($koneksi));
		...
		<script language="JavaScript">
        	...
        	document.location='form-tambah-user-admin.php?id_user=<?php echo $id_user; ?>';
      	</script>
		<?php
		}
		?>