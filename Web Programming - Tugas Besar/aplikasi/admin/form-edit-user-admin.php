...
<head>
  ...
  <title>The Logistic - Edit User Admin</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li><a href="data-admin.php"><b>Data Admin</b></a> / Edit User</li>
          </ol> 
          <!-- Page Heading -->                 
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
              <div class="card-body">
                ...
                <form action="pro-edit-user-admin.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
