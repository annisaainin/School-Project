...
$query = mysqli_query($koneksi,"INSERT INTO tb_toko(id_toko,nama_toko,telp_toko,wa_toko,rt_toko,rw_toko,jalan_toko,desa_toko,kec_toko,wil_toko,prov_toko,kode_pos,des_toko,jarak_toko,gmaps,id_user) VALUES('$id_toko','$nama_toko','$telp_toko','$wa_toko','$rt_toko','$rw_toko','$jalan_toko','$desa_toko','$kec_toko','$wil_toko','$prov_toko','$kode_pos','$des_toko','$jarak_toko','$gmaps','$nama_pemilik')")or die(mysqli_error($koneksi));
